...
<header class="bg-white border-b border-gray-200 shadow-sm">
    <div class="flex items-center justify-between py-3 px-6 md:px-10 mx-4 md:mx-8 lg:mx-12">
            ...
            <nav class="flex items-center space-x-1">
                <!-- Dashboard Tab -->
                <a href="https://qmscharlie.byethost5.com/Frontend/Personnel/Admin/Dashboard.php" class="nav-tab flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors" id="dashboardTab">
                    <i class="fas fa-home nav-icon text-gray-600"></i>
                    <span class="nav-text text-gray-600 font-medium">Dashboard</span>
                </a>
                
                <!-- Queue Management Tab -->
                <a href="https://qmscharlie.byethost5.com/Frontend/Personnel/Admin/Queue.php" class="nav-tab flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors" id="queueTab">
                ...
                <!-- Queue History Tab -->
                <a href="https://qmscharlie.byethost5.com/Frontend/Personnel/Admin/History.php" class="nav-tab flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors" id="historyTab">
                    <i class="fas fa-history nav-icon text-gray-600"></i>
                    <span class="nav-text text-gray-600 font-medium">Queue History</span>
                </a>
                
                <!-- Account Management Tab -->
                <a href="https://qmscharlie.byethost5.com/Frontend/Personnel/Admin/User.php" class="nav-tab flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors" id="userTab">
